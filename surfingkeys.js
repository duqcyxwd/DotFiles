...
function getElementsByText(str, tag = 'a') {
  return Array.prototype.slice
    ...
    .filter(el => el.textContent.includes(str.trim()));
}
...
let elementClick = (selectors) => () => document.querySelectorAll(selectors).forEach(e => e.click())
...
mapkey(
  ...
  function() {
    document
      .querySelectorAll('button[aria-label="Toggle navigation"]')[0]
      .click();
  },
  {
...
let gitlabToggleSidebar = function() {
...
mapkey(
  ...
  function() {
    document
      .querySelectorAll('.notifications-tc .notification')
      .forEach(e => e.click());
  },
  {
    domain: devDomain
