# Generated by Powerlevel10k configuration wizard on 2021-05-19 at 08:56 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_FOREGROUND=72
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
       ...
       '*desktop*' DEV_LOCAL # These values are examples that are unlikely
       '*chuan*'   DEV       # to match your needs. Customize them as needed.
       '*'         DEFAULT)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_CONTENT_EXPANSION='${:-$P9K_KUBECONTEXT_NAMESPACE}'


  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_LOCAL_FOREGROUND=2
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_LOCAL_CONTENT_EXPANSION='${P9K_CONTENT}'
  ...
  # Disanle this, I want do it manually
...
function p10k-on-post-prompt() {
  ...
  p10k display \
    ...
    '|2|/'=$second_line_show \
    '2/left_frame'=$dir_change \
    '2/left/dir'=$dir_change \
    '2/right/command_execution_time'=$show_last_command_timelapse \
